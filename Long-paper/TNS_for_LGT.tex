...
which simplifies to
\begin{equation}
	_{l'}\langle j'k'|\widehat{u}_{\alpha\beta}|jk\rangle_{l} = \sqrt{\frac{2l+1}{2l+2}} \sqrt{\frac{\ell+2\alpha j + 1}{2\ell+1}}\delta_{j', j + \alpha}  \sqrt{\frac{\ell+2\beta k + 1}{2\ell+1}}\delta_{k', k + \beta}\delta_{l',l+\frac12}  + \sqrt{\frac{2l+1}{2l}}\overline{d}_{j',(\beta,j)}d_{k',(\alpha,k)} \delta_{l',l-\frac12},
\end{equation}
