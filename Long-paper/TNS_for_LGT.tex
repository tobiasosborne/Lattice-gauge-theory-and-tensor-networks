...
\begin{equation}
	c_{k,(\alpha,j)} = \langle W_k^{\ell+\frac12}|\alpha, W_j^{\ell}\rangle = \begin{cases} \binom{2\ell+1}{\ell-j}^{-\frac12}\binom{2\ell}{\ell-j}^{\frac12} &\quad k = j+\frac12, \alpha = \uparrow\\ \binom{2\ell+1}{\ell-j+1}^{-\frac12}\binom{2\ell}{\ell-j}^{\frac12} &\quad k = j-\frac12, \alpha = \downarrow\end{cases},
\end{equation}
which simplifies to
\begin{equation}
	c_{k,(\alpha,j)} = \langle W_k^{\ell+\frac12}|\alpha, W_j^{\ell}\rangle = \begin{cases} \sqrt{\frac{\ell+j+1}{2\ell+1}} &\quad k = j+\frac12, \alpha = \uparrow\\ \binom{2\ell+1}{\ell-j+1}^{-\frac12}\binom{2\ell}{\ell-j}^{\frac12} &\quad k = j-\frac12, \alpha = \downarrow\end{cases}
\end{equation}
